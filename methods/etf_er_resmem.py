    ...
    def online_step(self, sample, sample_num, n_worker):
        ...
        if self.store_pickle and self.rnd_seed == 1:
            if self.sample_num % 100 == 0 and self.sample_num !=0:
                fc_pickle_name = "etf_resmem_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_sigma" + str(self.softmax_temperature) + "_criterion_" + self.select_criterion +  "_fc.pickle"
                feature_pickle_name = "etf_resmem_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_sigma" + str(self.softmax_temperature) + "_criterion_" + self.select_criterion + "_feature.pickle"
                class_pickle_name = "etf_resmem_sigma" + str(self.sigma) + "_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_sigma" + str(self.softmax_temperature) + "_criterion_" + self.select_criterion + "_class.pickle"
                pickle_name_feature_std_mean_list = "etf_remem_sigma" + str(self.sigma) + "_num_" + str(self.online_iter) + "_sigma" + str(self.softmax_temperature) + "_criterion_" + self.select_criterion + "_feature_std.pickle"
                pickle_name_stds_list = "etf_resmem_sigma" + str(self.sigma) + "_num_" + str(self.online_iter) + "_sigma" + str(self.softmax_temperature) + "_criterion_" + self.select_criterion + "_stds.pickle"
